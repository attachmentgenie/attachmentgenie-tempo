  ...
  on_supported_os.each do |os, facts|
    context "on #{os}" do
      ...
      context 'with group set to myspecialgroup and install_method set to archive' do
        ...
        it { is_expected.to contain_archive('/var/lib/tempo/tempo-0.5.0/tempo_0.5.0_linux_amd64.tar.gz').with_group('myspecialgroup') }
      end
      ...
      context 'with bin_dir set to /opt/special' do
        ...
        it { is_expected.to contain_archive('/var/lib/tempo/tempo-0.5.0/tempo_0.5.0_linux_amd64.tar.gz').with_creates('/var/lib/tempo/tempo-0.5.0/tempo') }
        it { is_expected.to contain_archive('/var/lib/tempo/tempo-0.5.0/tempo_0.5.0_linux_amd64.tar.gz').with_extract_path('/var/lib/tempo/tempo-0.5.0') }
      end
      ...
      context 'with install_method set to archive' do
        ...
        it { is_expected.to contain_archive('/opt/tempo/tempo-0.5.0/tempo_0.5.0_linux_amd64.tar.gz') }
      ...
      context 'with install_method set to package' do
        ...
        it { is_expected.not_to contain_archive('/var/lib/tempo/tempo-0.5.0/tempo_0.5.0_linux_amd64.tar.gz') }
      ...
      context 'with user set to myspecialuser and install_method set to archive' do
        ...
        it { is_expected.to contain_archive('/var/lib/tempo/tempo-0.5.0/tempo_0.5.0_linux_amd64.tar.gz').with_user('myspecialuser') }
      end
